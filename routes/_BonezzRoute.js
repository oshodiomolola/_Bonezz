...
_BonezzRouter.put("/updateBlog/:id", authController.isAuthenticated, _BonezzController.updateBlog);
_BonezzRouter.delete("/deleteBlog/:id", authController.isAuthenticated, _BonezzController.deleteBlog);
_BonezzRouter.put("/publishBlog/:id", authController.isAuthenticated, _BonezzController.publishBlog);
